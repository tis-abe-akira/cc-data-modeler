...
-- 人データ（社員・担当者）
INSERT INTO PERSON (name, email, created_at) VALUES
...
-- 組織データ（階層構造）
INSERT INTO ORGANIZATION (organization_name, organization_type, parent_organization_id, created_at) VALUES
...
-- 開発種別データ（タグ）
INSERT INTO DEVELOPMENT_TYPE (development_type_name, description, created_at) VALUES
...
-- 開発方式データ（タグ）
INSERT INTO DEVELOPMENT_METHOD (development_method_name, description, created_at) VALUES
...
-- 対象工程データ（タグ）
INSERT INTO TARGET_PHASE (target_phase_name, description, created_at) VALUES
...
-- 支援タイプデータ
INSERT INTO SUPPORT_TYPE (support_type_name, description, created_at) VALUES
...
-- ユーザーアカウントデータ
INSERT INTO USER_ACCOUNT (person_id, username, created_at) VALUES
...
-- プロジェクトデータ
INSERT INTO PROJECT (project_name, customer_id, estimated_effort, planned_start_date, planned_end_date, created_at) VALUES
...
INSERT INTO PROJECT_DEVELOPMENT_TYPE (project_id, development_type_id) VALUES
(1, 1), -- 次世代ECサイト: 新規開発
(2, 1), -- 勘定系リプレース: 新規開発
(3, 2), -- 生産管理: 保守開発
(3, 3); -- 生産管理: 機能追加
...
INSERT INTO PROJECT_DEVELOPMENT_METHOD (project_id, development_method_id) VALUES
(1, 1), -- 次世代ECサイト: アジャイル
(2, 3), -- 勘定系リプレース: ハイブリッド
(3, 2); -- 生産管理: ウォーターフォール

-- プロジェクトと対象工程の紐付け（タグ方式）
INSERT INTO PROJECT_TARGET_PHASE (project_id, target_phase_id) VALUES
...
-- プロジェクト開始（180日前）
INSERT INTO PROJECT_START (project_id, start_date_time, registered_by) VALUES
(1, CURRENT_TIMESTAMP - INTERVAL '180 days', 1);

-- 組織参画（180日前）
INSERT INTO ORGANIZATION_JOIN (project_id, organization_id, join_date_time, registered_by) VALUES
(1, 2, CURRENT_TIMESTAMP - INTERVAL '180 days', 1); -- 第一開発部

-- 担当者アサイン（180日前）
INSERT INTO PERSON_ASSIGN (project_id, person_id, role_id, assign_date_time, registered_by) VALUES
...
-- リスク評価（低リスク、150日前）
INSERT INTO RISK_EVALUATE (project_id, risk_rank, evaluate_date_time, evaluated_by, is_system_proposed, is_manual_adjusted) VALUES
(1, '低', CURRENT_TIMESTAMP - INTERVAL '150 days', 1, TRUE, FALSE);

-- 支援実施（技術支援、120日前）
INSERT INTO SUPPORT_EXECUTE (project_id, support_type_id, support_person_id, execute_date_time, support_content, outcome, memo) VALUES
(1, 1, 6, CURRENT_TIMESTAMP - INTERVAL '120 days', 'React最新バージョン移行サポート', 'React 18へのスムーズな移行完了', 'パフォーマンス改善を確認');

-- プロジェクト完了（35日前）
INSERT INTO PROJECT_COMPLETE (project_id, complete_date_time, actual_effort, registered_by) VALUES
...
-- 担当者交代（高橋 → 佐藤、80日前）
INSERT INTO PERSON_REPLACE (project_id, old_person_id, new_person_id, role_id, replace_date_time, registered_by) VALUES
